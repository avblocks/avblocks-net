...
namespace CliSample
{
    class Program
    {
        static int Main(string[] args)
        {
            ...
            bool padVideoResult = PadVideo(opt);

            Library.Shutdown();

            return padVideoResult ? (int)ExitCodes.Success : (int)ExitCodes.EncodeError;
        }
        ...
        static bool PadVideo(Options opt)
        {
            ...
            using (var transcoder = new Transcoder())
            {
                ...
                // Add Outputs
                {
                    ...
                    if (videoStreamInfo != null)
                    {
                        ...
                        outVideoPin.Params.Add(Param.Video.Pad.Left, opt.PadLeft);
                        outVideoPin.Params.Add(Param.Video.Pad.Right, opt.PadRight);
                        outVideoPin.Params.Add(Param.Video.Pad.Top, opt.PadTop);
                        outVideoPin.Params.Add(Param.Video.Pad.Bottom, opt.PadBottom);
                        outVideoPin.Params.Add(Param.Video.Pad.Color, opt.PadColor);
