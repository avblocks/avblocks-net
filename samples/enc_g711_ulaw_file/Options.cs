...
namespace CliSample
{
    class Options
    {
        // enc_g711_ulaw_file command line options
        [Option('i', "input", HelpText = "input WAV file")]
        public string InputFile { get; set; }

        [Option('o', "output", HelpText = "output G.711 μ-law WAV file")]
        ...
        void SetDefaultOptions()
        {
            ...
            OutputFile = Path.Combine(exeDir, "../../output/enc_g711_ulaw_file/express-dictate_g711_ulaw.wav");
