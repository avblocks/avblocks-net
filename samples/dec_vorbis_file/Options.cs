...
namespace CliSample
{
    class Options
    {
        // dec_vorbis_file command line options
        [Option('i', "input", HelpText = "input OGG file")]
        ...
        void SetDefaultOptions()
        {
            ...
            OutputFile = Path.Combine(exeDir, "../../output/dec_vorbis_file/Hydrate-Kenny_Beltrey.wav");
