...
namespace CliSample
{
    class Options
    {
        // enc_aac_adts_file command line options
        [Option('i', "input", HelpText = "input WAV file")]
        public string InputFile { get; set; }

        [Option('o', "output", HelpText = "output AAC file")]
        ...
        void SetDefaultOptions()
        {
            ...
            OutputFile = Path.Combine(exeDir, "../../output/enc_aac_adts_file/equinox-48KHz.adts.aac");
