...
namespace CliSample
{
    class Options
    {
        // enc_vp8_file command line options
        [Option('i', "input", HelpText = "input YUV file")]
        public string InputFile { get; set; }

        [Option('o', "output", HelpText = "output IVF file")]
        ...
        void SetDefaultOptions()
        {
            ...
            OutputFile = Path.Combine(exeDir, "../../output/enc_vp8_file/foreman_qcif.ivf");
            ...
            Console.Write("enc_vp8_file --input " + InputFile);
