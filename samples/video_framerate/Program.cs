...
namespace CliSample
{
    class Program
    {
        static int Main(string[] args)
        {
            ...
            bool changeFrameRateResult = ChangeFrameRate(opt);

            Library.Shutdown();

            return changeFrameRateResult ? (int)ExitCodes.Success : (int)ExitCodes.EncodeError;
        }
        ...
        static bool ChangeFrameRate(Options opt)
        {
            ...
            using (var transcoder = new Transcoder())
            {
                ...
                // Add Outputs
                {
                    ...
                    // Add video pin with frame rate change
                    ...
                    if (videoStreamInfo != null)
                    {
                        ...
                        {
                            outVideoStreamInfo.FrameRate = opt.FrameRate;
                        }
