...
namespace CliSample
{
    class Options
    {
        // dec_vp8_file command line options
        [Option('i', "input", HelpText = "input VP8/IVF file")]
        ...
        void SetDefaultOptions()
        {
            ...
            InputFile = Path.Combine(exeDir, "../../assets/vid/foreman_qcif_vp8.ivf");
            OutputFile = Path.Combine(exeDir, "../../output/dec_vp8_file/foreman_qcif.yuv");
