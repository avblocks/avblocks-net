...
namespace CliSample
{
    class Options
    {
        // dec_opus_file command line options
        [Option('i', "input", HelpText = "input Opus file")]
        ...
        void SetDefaultOptions()
        {
            ...
            InputFile = Path.Combine(exeDir, "../../assets/aud/Everybody-TBB.opus");
            OutputFile = Path.Combine(exeDir, "../../output/dec_opus_file/Everybody-TBB.wav");
