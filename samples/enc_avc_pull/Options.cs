...
namespace CliSample
{
    class Options
    {
        // enc_avc_pull command line options
        [Option('i', "input", HelpText = "input YUV file")]
        public string InputFile { get; set; }

        [Option('o', "output", HelpText = "output AVC / H.264 file")]
        ...
        void SetDefaultOptions()
        {
            ...
            OutputFile = Path.Combine(exeDir, "../../output/enc_avc_pull/foreman_qcif.h264");
            ...
            Console.Write("enc_avc_pull --input " + InputFile);
